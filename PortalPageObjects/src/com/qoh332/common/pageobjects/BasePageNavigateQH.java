...
public class BasePageNavigateQH {
	...
	String textWelcomeTextOther = "Navigate Portal";
	
	public BasePageNavigateQH(WebDriver driver) {
		this.driver = driver;
	}
	...
	public boolean verifyBasePageTitle() {
		...
		String expectedPageTitle="Navigate Login";
